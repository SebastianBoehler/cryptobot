...
const binance = new Binance().options({
  APIKEY: 'RbylZBGeoAys1HIPRYD5JT7wd8MqJ2gzmb0YGQM6G',
  APISECRET: 'RbylZBGeoAys1HIPRYAnhDjvyyq6yow4viqzmb0YGQM6G'
});
...
const doc = new GoogleSpreadsheet('11uXOxpfZieOf5pdrcyztssS3SNtA7YGUTE');
...
const webhook = new Discord.WebhookClient('832997472736641105', 'XWlsXwD4NSsuVJJzlCeRZvISgsYzzrEac85JxbgiN0lXcr5jY0tccNRlhErCEGJezNpX');

process.on('unhandledRejection', (error, promise) => {
  // Will print "unhandledRejection err is not defined"
  console.log('unhandledRejection', error.message, promise);
  webhook.send('ruletester3_slow\n' + error.message + '\n' + promise)
...
//done by ruletester fast
if (index === 0 && false) schedule.scheduleJob('00 0 14 * * *', async function () {
  ...
  if (!data) return
  fs.writeFileSync('./products.json', JSON.stringify(data, null, 3), {
    encoding: 'utf-8'
  })
  index = value
});
...
async function tester(symbol, volumeIndex) {
  ...
  for (var a = 9200; a < history.length; a = a + 1) { //9200
    ...
    let Indicators30min = await generateIndicators(30, symbol + 'PERP', factor - 1, a)
    //let Indicators60min = await generateIndicators(60, symbol + 'PERP', factor, a - 2)
    let Indicators60min = await generateIndicators(60, symbol + 'PERP', factor - 2, a)

    if (!Indicators5min || !Indicators30min || !Indicators60min) {
      a--
      continue
    }
    ...
    for (var u in rules) {
      ...
      let ruleStorage = {
        'test80': {
          "Long Entry": [
            [
              ...
              Indicators30min['RSI_EMA'] >= Indicators30min['RSI_EMA_prev'],
              //!(Indicators5min['volatility']['latest'] >= Indicators5min['volatility']['avg'] && Indicators5min['volatility']['direction'] === 'down'),
              Math.abs(Indicators60min['eight'] / Indicators60min['thirteen'] - 1) >= 0.0005,
              //Math.abs(Indicators90min['eight'] / Indicators90min['thirteen'] - 1) >= 0.0005
            ]
          ],
          "Long Exit": [
            [
              Indicators30min['RSI_EMA'] < Indicators30min['RSI_EMA_prev'] || (Indicators30min['RSI'] > 70 && Indicators30min['RSI'] < Indicators30min['RSI_prev']),
            ]
          ],
          "Short Entry": [
            [
          ...
          "Short Exit": [
            [
              Indicators30min['RSI_EMA'] > Indicators30min['RSI_EMA_prev'] || (Indicators30min['RSI'] < 40 && Indicators30min['RSI'] > Indicators30min['RSI_prev']),
            ]
          ],
          'details': [
        ...
        'test81': {
          "Long Entry": [
            [
              ...
              Indicators5min['RSI_EMA'] > Indicators5min['RSI_EMA_prev'],
              Indicators30min['RSI_EMA'] >= Indicators30min['RSI_EMA_prev'],
              Indicators30min['RSI'] > Indicators30min['RSI_EMA'],
              Indicators30min['RSI_prev'] < Indicators30min['RSI_EMA_prev'],
              //!(Indicators5min['volatility']['latest'] >= Indicators5min['volatility']['avg'] && Indicators5min['volatility']['direction'] === 'down'),
              Math.abs(Indicators60min['eight'] / Indicators60min['thirteen'] - 1) >= 0.0005,
              //Math.abs(Indicators90min['eight'] / Indicators90min['thirteen'] - 1) >= 0.0005
            ]
        ...
        'test82': {
          ...
          "Long Exit": [
            [
              Indicators30min['RSI_EMA'] < Indicators30min['RSI_EMA_prev'] || (Indicators30min['RSI'] > 70 && Indicators30min['RSI'] < Indicators30min['RSI_prev']) || profit < -3,
            ]
          ],
          "Short Entry": [
            [
          ...
          "Short Exit": [
            [
              Indicators30min['RSI_EMA'] > Indicators30min['RSI_EMA_prev'] || (Indicators30min['RSI'] < 40 && Indicators30min['RSI'] > Indicators30min['RSI_prev']) || profit < -3,
            ]
          ],
          'details': [
            //Indicators15min['fiftyfive'],
