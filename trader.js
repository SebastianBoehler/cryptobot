...
const webhook = new Discord.WebhookClient('776017258564157442', 'TID_qcqYUROzy2na7a0c3t2odTAQBf5kFVQOF100c6eaMPDTcPw8');

const accounts = [
  {
    portfolio: 'Binance #5',
    key: 'PfUjDL7zg2dAvsfqZAnlOJ6LZi6bLYF7Uw31fhnUlwu',
    secret: 'c2l7AwvZ6cemt33szejM9XUV2Vb',
    active: true,
    ...
    const rules = {
      'Binance #1': {
        'buy': [
          ...
          [
            //big down trend candle
            data15min['HeikinAshi']['open'] / data15min['HeikinAshi']['close'] >= 1.01
          ],
          [
            //DOJI UPTREND
            data15min['HeikinAshi']['close'] > data15min['HeikinAshi']['open'],
            data15min['HeikinAshi']['high'] - data15min['HeikinAshi']['close'] > (data15min['HeikinAshi']['close'] - data15min['HeikinAshi']['open']) * 2,
            data15min['HeikinAshi']['open'] - data15min['HeikinAshi']['low'] > (data15min['HeikinAshi']['close'] - data15min['HeikinAshi']['open']) * 2
          ],
          [
            //confirm uptrend
            data15min['HeikinAshi']['low'] === data15min['HeikinAshi']['open'],
            data15min['lineMoving'] === 1
          ]
        ],
        'sell': [
          [
      ...
      'Binance #5': {
        'buy': [
          ...
          [
            //big down trend candle
            data15min['MACD']['MACD'] > data15min['MACD']['signal']
          ]
        ],
        'sell': [
          [
